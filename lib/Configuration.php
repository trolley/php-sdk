...
class Configuration
{
     ...
     *
     * @var \PaymentRails\Client\ApiClient
     */
     ...
     * @var string
     */
    protected $host = 'https://api.paymentrails.com/v1';
    ...
    /**
     * User agent of the HTTP request, set to "PHP-PaymentRails" by default
     *
     * @var string
     */
    protected $userAgent = "PaymentRails-Codegen/1.0.0/php";
    ...
    {
        $report  = 'PHP SDK (PaymentRails\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . phpversion() . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 1.31.0' . PHP_EOL;
