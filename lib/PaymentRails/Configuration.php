...
class Configuration
{
    ...
    public function assertHasClientId()
    {
        if (empty($this->_clientId)) {
            throw new Exception\Configuration('clientId needs to be passed to PaymentRails\\Gateway.');
        }
    }
    ...
    public function assertHasClientSecret()
    {
        if (empty($this->_clientSecret)) {
            throw new Exception\Configuration('clientSecret needs to be passed to PaymentRails\\Gateway.');
        }
    }
...
Configuration::reset();
class_alias('PaymentRails\Configuration', 'PaymentRails_Configuration');
