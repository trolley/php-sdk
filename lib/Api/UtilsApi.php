...
class UtilsApi
{
     ...
     * @return \PaymentRails\Client\Model\Currency
     ...
     *
     * @param string $currency_code 2 letters ISO country code (required)
     * @return Array of \PaymentRails\Client\Model\Currency, HTTP status code, HTTP response headers (array of strings)
     * @throws \PaymentRails\Client\ApiException on non-2xx response
     */
    public function getCurrencyWithHttpInfo($currency_code)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\PaymentRails\Client\Model\Currency', $e->getResponseHeaders());
