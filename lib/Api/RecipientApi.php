...
class RecipientApi
{
     ...
     * @param \PaymentRails\Client\Model\BankAccount $body  (required)
     * @return \PaymentRails\Client\Model\BankAccount
     ...
     * @param string $recipient_id  (required)
     * @param \PaymentRails\Client\Model\BankAccount $body  (required)
     * @return Array of \PaymentRails\Client\Model\BankAccount, HTTP status code, HTTP response headers (array of strings)
     * @throws \PaymentRails\Client\ApiException on non-2xx response
     */
    public function createBankAccountWithHttpInfo($recipient_id, $body)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\PaymentRails\Client\Model\BankAccount', $e->getResponseHeaders());
     ...
     *
     * @param string $recipient_id  (required)
     * @param \PaymentRails\Client\Model\PaypalAccount $body paypal payout account (required)
     * @return \PaymentRails\Client\Model\PaypalAccount
     * @throws \PaymentRails\Client\ApiException on non-2xx response
     */
     ...
     * @param string $recipient_id  (required)
     * @param \PaymentRails\Client\Model\PaypalAccount $body paypal payout account (required)
     * @return Array of \PaymentRails\Client\Model\PaypalAccount, HTTP status code, HTTP response headers (array of strings)
     * @throws \PaymentRails\Client\ApiException on non-2xx response
     */
    public function createPaypalAccountWithHttpInfo($recipient_id, $body)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\PaymentRails\Client\Model\PaypalAccount', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @param \PaymentRails\Client\Model\RecipientPayoutMethods $body  (required)
     ...
     * @param string $recipient_id R-XXXXXXXXXXXXXXXX (required)
     * @param \PaymentRails\Client\Model\RecipientPayoutMethods $body  (required)
     * @return Array of \PaymentRails\Client\Model\RecipientPayoutMethods, HTTP status code, HTTP response headers (array of strings)
     * @throws \PaymentRails\Client\ApiException on non-2xx response
     */
    public function createRecipientPayoutMethodsWithHttpInfo($recipient_id, $body)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\PaymentRails\Client\Model\RecipientPayoutMethods', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     *
     * @param string $recipient_id R-XXXXXXXXXXXXXXXX (required)
     * @return \PaymentRails\Client\Model\RecipientInfoOut
     * @throws \PaymentRails\Client\ApiException on non-2xx response
     */
     ...
     *
     * @param string $recipient_id R-XXXXXXXXXXXXXXXX (required)
     * @return Array of \PaymentRails\Client\Model\RecipientInfoOut, HTTP status code, HTTP response headers (array of strings)
     * @throws \PaymentRails\Client\ApiException on non-2xx response
     */
    public function getRecipientInfoWithHttpInfo($recipient_id)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\PaymentRails\Client\Model\RecipientInfoOut', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     *
     * @param string $recipient_id R-XXXXXXXXXXXXXXXX (required)
     * @param \PaymentRails\Client\Model\RecipientPost $body  (required)
     * @return \PaymentRails\Client\Model\Recipient
     * @throws \PaymentRails\Client\ApiException on non-2xx response
     */
     ...
     *
     * @param string $recipient_id R-XXXXXXXXXXXXXXXX (required)
     * @param \PaymentRails\Client\Model\RecipientInfoIn $body  (required)
     * @return \PaymentRails\Client\Model\RecipientInfoOut
     * @throws \PaymentRails\Client\ApiException on non-2xx response
     */
