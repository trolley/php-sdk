...
class PaymentsApi
{
     ...
     *
     * @param string $payment_id P-XXXXXXXXXXXXXXXX (required)
     * @return Array of \PaymentRails\Client\Model\PaymentOut, HTTP status code, HTTP response headers (array of strings)
     * @throws \PaymentRails\Client\ApiException on non-2xx response
     */
    public function getPaymentWithHttpInfo($payment_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\PaymentRails\Client\Model\PaymentOut',
                '/v1/payments/{paymentId}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\PaymentRails\Client\Model\PaymentOut', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\PaymentRails\Client\Model\PaymentOut', $e->getResponseHeaders());
